...
WHEEL_R = 14  # 27 wheel radius
WHEEL_W = 14  # wheel width
# WHEELPOS = [(-55, +80), (+55, +80), (-55, -82), (+55, -82)]
ROBOT_RADIUS = 80
WHEELPOS = [(s1 * ROBOT_RADIUS, s2 * ROBOT_RADIUS) for s1, s2 in
            [(-1, -1,), (1, -1), (-1, 1), (1, 1)]]
HULL_POLY1 = [(s1 * (ROBOT_RADIUS - WHEEL_W), s2 * (ROBOT_RADIUS - WHEEL_W))
...
class Robot:
    ...
    def step(self, dt):
        for w in self.wheels:
            ...
            oscillation_coef = 20500
            f_force *= oscillation_coef * SIZE * SIZE
            p_force *= oscillation_coef * SIZE * SIZE
