...
#         3, 1, 1 + self.env.track_samples)  # ([angle, y, x], 1, [*car, *world])
...
#         self.training_steps = 200e3  # Total number of training steps (ie weights update according to a batch)
...
#         self.reanalyse_on_gpu = True  # Use GPU for the reanalyse phase. Paper recommends false (on CPU)
#
...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Replay Buffer
        self.replay_buffer_size = 20e3  # Number of self-play games to keep in the replay buffer
...
class TilePlacingEnv(gym.Env, EzPickle):
    ...
    def __init__(self, verbose=1):
        ...
        self.max_steps_without_reward = 50
        self.last_step_positive_reward = None
        self.track_samples = 30
        self.steps = None
        self.seed()
